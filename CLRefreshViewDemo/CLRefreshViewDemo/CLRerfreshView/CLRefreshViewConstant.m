...
NSString *const CLScrollViewContentOffsetKeyPath = @"contentOffset";
...
const CGFloat CLRefreshHeaderVeiwHeight = 60.0f;

const CGFloat CLRefreshFooterVeiwHeight = 40.0f;

const CGFloat CLRefreshAnimationDurationNormal = 0.25f;
